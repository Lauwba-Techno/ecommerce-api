...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form class="user" action="/help-store" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user text-muted" id="help_name"
                            name="help_name" placeholder="Nama Bantuan">
                    </div>
                    <div class="form-group">
                        <input class="form-control" id="help_image" name="help_image" type="file">
                    </div>
                    <div class="form-group">
                        <Textarea class="form-control text-muted" id="help_desc" name="help_desc" rows="5"

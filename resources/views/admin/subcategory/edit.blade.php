...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form class="user" action="/subcategory-update/{{ $subcategory->subcategory_id }}" method="POST"
                    ...
                    <div class="form-group">
                        <select class="form-control text-muted" id="category_id" name="category_id">
                            ...
                            @foreach ($category as $item)
                                <option value="{{ $item->category_id }}" @selected($item->category_id == $subcategory->category_id)>
